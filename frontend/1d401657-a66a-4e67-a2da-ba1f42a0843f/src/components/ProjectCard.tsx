...
export const ProjectCard = ({
  ...
  if (viewMode === 'list') {
    return <div className="bg-white rounded-md border border-gray-200 p-3 flex items-center hover:shadow-md transition-shadow cursor-pointer" onClick={onOpen}>
        <div className="w-12 h-12 bg-gray-200 rounded overflow-hidden mr-4 flex-shrink-0">
          {project.thumbnail ? <img src={project.thumbnail} alt={project.name} className="w-full h-full object-cover" /> : <div className="w-full h-full flex items-center justify-center bg-blue-100">
  ...
  return <div className="bg-white rounded-md border border-gray-200 overflow-hidden hover:shadow-md transition-shadow cursor-pointer" onClick={onOpen}>
